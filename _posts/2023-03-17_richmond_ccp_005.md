...
Event: ccp
Session: '005'
Group Questions: How do we maintain faith that there are no mistakes and we will receive the catalyst we need? How do we stay centered in spite of the various worries that arise in our minds? How do we navigate within that uncertainty and find our grounding in the goodness of this Creation?
