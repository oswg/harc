...
- 
Ariadne's thread refers to an exhaustive application of logic to all available routes to an answer to some problem. For more, see [Wikipedia](https://en.wikipedia.org/wiki/Ariadne%27s_thread_(logic)).
